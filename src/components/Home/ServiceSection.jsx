...
const services = [
  {
    ...
    desc: `Nice car, bad wheels? We can fix and shape up your wheels to make them look amazing again!`,
    image: "/carpaint.avif",
  ...
  {
    title: "NEW & USED TYRES",
    desc: `Next Wheels & Tyres Gloucester, are your number 1 choice for both new and part worn tyres.`,
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[85%] mx-auto mt-25 h-25 object-cover"
                    onError={(e) => {
