...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Their customer service start to finish was impeccable! I was updated throughout the day, given the best hand over ever and most importantly my exhaust and wheels are even better than I could have hoped for!",
    name: "Leonie Seavor",
  },
